...
class MunicipioListByIdServiceDataView (APIView):
...
#    required_scopes        = ['francapaisa_zonas_scope']
    ...
    def get (self, request, idMunicipio, format = None, *args, **kwargs):

        municipioData = MunicipioModel.objects.get_by_id_municipio (idMunicipio)
