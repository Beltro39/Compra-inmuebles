...
class ScrappingListByIdServiceDataView (APIView):
...
#    required_scopes        = ['francapaisa_inmuebles_scope']
    ...
    def get (self, request, idScrapping, format = None, *args, **kwargs):

        scrappingData = ScrappingModel.objects.get_by_id_scrapping (idScrapping)
