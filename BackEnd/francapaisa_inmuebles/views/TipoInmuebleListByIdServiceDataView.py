...
class TipoInmuebleListByIdServiceDataView (APIView):
...
#    required_scopes        = ['francapaisa_inmuebles_scope']
    ...
    def get (self, request, idTipoInmueble, format = None, *args, **kwargs):

        tipoInmuebleData = TipoInmuebleModel.objects.get_by_id_tipo_inmueble (idTipoInmueble)
